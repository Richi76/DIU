 ...
 * Patrón "Gallery" para mostrar imágenes, en nuestro caso relativas a las habitaciones. El usuario debe navegar fácilmente a través de la galería, y además que esta navegación tenga un sentido, es decir, que el orden en que aparecen las imágenes este estructurado y tengas la sensación más cercana posible a estar visitando el lugar.
